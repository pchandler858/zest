...
export type BarCanvasLayer<RawDatum> = Exclude<BarLayerId, 'markers'> | BarCanvasCustomLayer<RawDatum>;
...
export type RenderBarProps<RawDatum extends BarDatum> = Omit<BarItemProps<RawDatum>, 'isInteractive' | 'style' | 'tooltip' | 'isFocusable' | 'ariaLabel' | 'ariaLabelledBy' | 'ariaDescribedBy'> & {
    borderColor: string;
    labelColor: string;
};
